...
COMMENT ON FUNCTION has_role IS 'Check if user has any of the specified roles';
...
COMMENT ON FUNCTION has_role IS 'Security fix: RBAC helper function for RLS policies';
