-- =====================================================
-- ACADEMY MODULE ENHANCEMENTS (With ENUMs)
...
DO $$ BEGIN
  CREATE TYPE enrollment_status AS ENUM ('pending', 'active', 'completed', 'dropped', 'expired');
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
  CREATE TYPE streak_type_enum AS ENUM ('daily_login', 'daily_learning', 'weekly_completion');
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
  CREATE TYPE leaderboard_scope AS ENUM ('org', 'department', 'course');
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
