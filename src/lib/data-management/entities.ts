...
export const ENTITY_CONFIGS: Record<string, EntityConfig> = {
  ...
  contacts: {
    ...
    fields: [
      ...
      { name: 'subtype', dbColumn: 'subtype', displayName: 'Subtype', type: 'string', required: false, importable: true, exportable: true, enumValues: ['client_poc', 'candidate', 'vendor', 'prospect', 'lead', 'partner', 'internal', 'general'], defaultValue: 'general' },
