...
export function CreateJobClient({ initialData }: CreateJobClientProps) {
  ...
  // Build account options from server data - NO client query needed
  const accountOptions = initialData.accounts.map((a) => ({
    value: a.id,
    label: a.name,
  }))
