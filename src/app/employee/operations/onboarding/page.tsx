    ...
    <div className="min-h-screen bg-cream p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <Button variant="outline" onClick={() => router.push('/employee/operations/onboarding/templates')}>
            <FileText className="h-4 w-4 mr-2" />
            Templates
          </Button>
          <Button onClick={() => router.push('/employee/operations/employees?status=onboarding')}>
              ...
              <div className="space-y-3">
                {(displayedOverdue as DashboardTask[] | undefined)?.map((task) => (
                  <div
                    ...
                    onClick={() => router.push(`/employee/operations/onboarding/${task.onboardingId}`)}
                  >
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Button
              variant="ghost"
              size="sm"
              onClick={() => router.push('/employee/operations/onboarding/templates')}
            >
              ...
              <div className="space-y-2">
                {templates?.slice(0, 5).map((template) => (
                  <div
                    ...
                    onClick={() =>
                      router.push(`/employee/operations/onboarding/templates?id=${template.id}`)
                    }
                  >
                    <div>
