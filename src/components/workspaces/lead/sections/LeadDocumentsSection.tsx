...
import { Plus, FileText, Download, ExternalLink, File, Image, FileSpreadsheet } from 'lucide-react'
...
export function LeadDocumentsSection({ documents, leadId, onUploadDocument }: LeadDocumentsSectionProps) {
  return (
        ...
        <CardContent className="p-0">
          {documents.length > 0 ? (
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-sm text-charcoal-500">No documents uploaded for this lead</p>
              <Button variant="outline" size="sm" className="mt-4" onClick={onUploadDocument}>
                <Plus className="h-4 w-4 mr-1" />
