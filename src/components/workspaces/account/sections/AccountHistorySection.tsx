...
/**
 * AccountHistorySection - Premium audit trail with table-based list view
 * Follows the same pattern as Activities/Notes sections
 */
export function AccountHistorySection({ history }: AccountHistorySectionProps) {
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-sm text-charcoal-500 mt-1">
              {searchQuery || changeTypeFilter !== 'all'
                ...
                : 'Changes to this account will appear here'}
            </p>
          </div>
        )}
...
function getActionDescription(entry: HistoryEntry): string {
  ...
  if (metadata?.action === 'entity_created') {
    return entry.newValueLabel || 'Created this account'
  }
