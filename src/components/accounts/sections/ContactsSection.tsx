...
import { CONTACT_ROLES, DECISION_AUTHORITY, CONTACT_METHODS, getLabel } from '@/lib/accounts/constants'
 ...
 * - create: Full form for wizard step (Step 4)
    ...
    return (
      <div className={cn('space-y-6', className)}>
        <SectionWrapper
          icon={Users}
          title="Key Contacts"
          subtitle="Add key stakeholders and contacts for this account"
        >
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-heading font-semibold text-charcoal-900">Contacts</h2>
          <p className="text-sm text-charcoal-500 mt-1">
            Key stakeholders and contacts ({data.contacts.length})
          </p>
        </div>
      ...
      {data.contacts.length > 0 ? (
        ...
        <div className="text-center py-12 bg-charcoal-50/50 rounded-xl border border-dashed border-charcoal-200">
          <Users className="w-10 h-10 text-charcoal-300 mx-auto mb-3" />
          <p className="text-sm text-charcoal-500 mb-1 font-medium">No contacts added yet</p>
          <p className="text-xs text-charcoal-400 mb-4">Add your first contact to get started</p>
