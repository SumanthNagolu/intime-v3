...
interface ActivityInlinePanelProps {
...
export function ActivityInlinePanel({
  activityId,
  accountId,
  onClose,
}: ActivityInlinePanelProps) {
  ...
  const headerActions = !isEditing && activity && (
      ...
      {activityQuery.isLoading ? (
        ...
        isEditing ? (
          ...
          <InlinePanelContent>
            ...
            {activity.next_steps && (
              <InlinePanelSection title="Next Steps">
                <div className="bg-charcoal-50 rounded-lg p-4">
