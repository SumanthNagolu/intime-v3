...
interface PlacementsListClientProps {
  initialPlacements: Placement[]
}

export function PlacementsListClient({ initialPlacements }: PlacementsListClientProps) {
  ...
  // Fetch placements with initialData
  const { data, refetch } = trpc.ats.placements.list.useQuery(
    {
    ...
    {
      initialData: { items: initialPlacements, total: initialPlacements.length },
    }
  )
                  ...
                  {filteredPlacements.map((placement) => {
                    ...
                    return (
                      <TableRow
                        ...
                        onMouseEnter={() => router.prefetch(`/employee/recruiting/placements/${placement.id}`)}
                      >
                        <TableCell>
                          <div>
