/**
 * Activity Components (Guidewire-inspired Activity System)
 * 
 * These components implement the Guidewire activity pattern:
 * - Activity Detail Panel with notes, history, and checklist
 * - Pattern Picker for creating activities from templates
 * - Checklist and Notes thread components
 */
