...
export const CandidateDashboard: React.FC = () => {
  ...
  // Simple progress tracking (will be replaced with real Supabase data later)
  const [academyProgress, setAcademyProgress] = useState<Record<string, { status: string }>>({});

  useEffect(() => {
    // Initialize progress for first lesson as unlocked
  ...
  useEffect(() => {
    ...
    const activities = [
        ...
        { user: "Alex M.", action: "earned 'Gosu Wizard' badge", type: "milestone" as const },
        { user: "Taylor S.", action: "started Module 4", type: "milestone" as const },
        { user: "Casey L.", action: "passed Quiz 3.1", type: "quiz" as const },
        { user: "Morgan R.", action: "completed Sprint Review", type: "milestone" as const }
    ];
