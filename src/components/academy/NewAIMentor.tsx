...
import { AcademyChatMessage } from '@/types/academy';

// Mock function - will be replaced with real AI integration
const generateMentorResponse = async (message: string): Promise<string> => {
  await new Promise(resolve => setTimeout(resolve, 1000));
  return "This is a mock response. The AI mentor will be integrated with the existing infrastructure soon.";
};
