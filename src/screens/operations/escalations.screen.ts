        ...
        sections: [
          {
            ...
            columns: [
              ...
              },
              {
                ...
                field: 'subject',
                type: 'link',
                linkPattern: '/employee/manager/escalations/{{id}}',
              },
              {
                id: 'category',
                header: 'Category',
              ...
              },
              {
                ...
                field: 'accountName',
                type: 'link',
                linkPattern: '/employee/crm/accounts/{{accountId}}',
              },
              {
                id: 'age',
                header: 'Age',
                ...
                actions: [
                  {
                    ...
                    icon: 'user-check',
                    action: { type: 'mutation', mutation: 'escalations.takeOwnership' },
                    visible: {
                      type: 'condition',
                  ...
                  },
                  {
                    ...
                    label: 'View Details',
                    icon: 'eye',
                    action: { type: 'navigate', path: '/employee/manager/escalations/{{id}}' },
                  },
                ],
                width: '100px',
              },
