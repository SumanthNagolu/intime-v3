...
- [D01-create-job.md](./D01-create-job.md) - Create the job requisition first
- [E01-source-candidates.md](./E01-source-candidates.md) - Source candidates for job
- [F01-submit-candidate.md](./F01-submit-candidate.md) - Submit candidate to client
- [F03-schedule-interview.md](./F03-schedule-interview.md) - Schedule interviews
- [G01-extend-offer.md](./G01-extend-offer.md) - Extend offer before placement
- [G04-manage-placement.md](./G04-manage-placement.md) - HR onboarding process
