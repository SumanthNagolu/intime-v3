...
**Next Workflow:** Automatically triggers [G03-confirm-placement.md](./G03-confirm-placement.md)
...
Offers support the candidate's preferred currency with client billing in contract currency:

| Currency Scenario | Pay Rate | Bill Rate | Commission Base |
|-------------------|----------|-----------|-----------------|
| US Client + US Candidate | USD | USD | USD |
| US Client + Canada Candidate | CAD | USD | USD |
| UK Client + EU Candidate | EUR | GBP | GBP |
| Global Client + India Candidate | INR | USD | USD |

**Exchange Rate Locking:**
- Exchange rate locked at offer acceptance
- Rate stored in offer record for commission calculation
- Monthly reconciliation for long-term contracts

### Regional Offer Templates

| Region | Template | Legal Requirements |
|--------|----------|-------------------|
| **US** | Standard W2, C2C, 1099 | At-will employment, state-specific addenda |
| **Canada** | Canadian Employment Agreement | Provincial labor law compliance |
| **UK** | UK Contract | IR35 determination, right-to-work |
| **EU** | EU Employment Contract | GDPR consent, working time directive |
| **India** | Indian Service Agreement | PF/ESI compliance, gratuity |

### Multi-Regional Approval Workflow

```
Offer Creation Flow (Enterprise):
...
### Compliance Documentation by Region

| Region | Required Documents |
|--------|-------------------|
| **US** | W-4, I-9, Direct Deposit, Background Consent |
| **Canada** | TD1, SIN Declaration, Direct Deposit |
| **UK** | P45/P46, National Insurance, Right-to-Work |
| **EU** | Tax Declaration, Social Security, GDPR Consent |
| **India** | PAN Declaration, Address Proof, Bank Details |

### Commission Calculation (5% Gross - Multi-Currency)

```
Multi-Currency Commission Example:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

UK Client, EU Candidate:
Bill Rate: £100/hr (GBP)
Pay Rate: €100/hr (EUR)

Exchange Rates (at offer acceptance):
- 1 EUR = 0.86 GBP
- 1 GBP = 1.27 USD

Pay Rate in GBP: €100 × 0.86 = £86/hr
Margin: £100 - £86 = £14/hr (14%)

Monthly Revenue (GBP): £100 × 176 = £17,600
Commission (5%): £17,600 × 0.05 = £880/month
Commission (USD): £880 × 1.27 = $1,118/month
```

### Enterprise Signature Workflow

| Region | eSignature Provider | Legal Validity |
|--------|--------------------|-----------------| 
| US/Canada | DocuSign | ESIGN Act, UETA |
| EU | DocuSign + eIDAS | eIDAS Regulation |
| UK | DocuSign | Electronic Communications Act |
| India | DigiLocker/Aadhaar eSign | IT Act 2000 |

### Global Audit Trail

All offer actions tracked with regional compliance metadata:
...
```json
{
  ...
  "audit_trail": [
    ...
    },
    {
      ...
      "approval_type": "cross_border"
    },
    {
      "action": "offer.sent",
      "delivery_method": "docusign_eidas",
      "recipient_region": "EU"
    }
  ]
}
...
| Benefit | US | Canada | UK | EU | India |
|---------|-----|--------|-----|-----|-------|
| Health Insurance | ✓ (employer) | ✓ (supplemental) | NHS | Country-specific | ✓ (ESI) |
| Retirement | 401(k) | RRSP | Pension | Country-specific | PF/Gratuity |
| PTO | 15 days | Provincial min | 28 days | EU directive | 15 days |
| Sick Leave | Per policy | Provincial | Statutory | Statutory | Per policy |
