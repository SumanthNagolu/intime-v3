...
- [02-create-job.md](./02-create-job.md) - Create jobs that appear in pipeline
- [03-source-candidates.md](./03-source-candidates.md) - Source candidates to add to pipeline
- [04-submit-candidate.md](./04-submit-candidate.md) - Submit candidates (creates Submitted stage entry)
- [05-schedule-interview.md](./05-schedule-interview.md) - Move to Interview stage
- [06-make-placement.md](./06-make-placement.md) - Final stage: Placed
- [09-track-activities.md](./09-track-activities.md) - Log activities from pipeline
- [10-update-job-status.md](./10-update-job-status.md) - Job status affects pipeline display
