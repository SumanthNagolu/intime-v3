...
See [04-submit-candidate.md](./04-submit-candidate.md) for field-by-field detail.
...
See [05-schedule-interview.md](./05-schedule-interview.md) for field-by-field detail.
