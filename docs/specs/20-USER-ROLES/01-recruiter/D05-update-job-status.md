...
- [D01-create-job.md](./D01-create-job.md) - Creating the job initially (Draft status)
- [E01-source-candidates.md](./E01-source-candidates.md) - Sourcing candidates (Open/Active status)
- [F01-submit-candidate.md](./F01-submit-candidate.md) - Submitting to client (triggers Active status)
- [G08-make-placement.md](./G08-make-placement.md) - Placement triggers Filled status
- [D06-close-job.md](./D06-close-job.md) - Detailed flow for reopening Filled/Cancelled jobs
