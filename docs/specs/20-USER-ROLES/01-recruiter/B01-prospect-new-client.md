...
- [B02-qualify-opportunity.md](./B02-qualify-opportunity.md) - Next step after prospecting
- [C01-create-account.md](./C01-create-account.md) - If lead qualifies and becomes client
- [A04-create-lead.md](./A04-create-lead.md) - Legacy workflow
- [C04-manage-client-relationship.md](./C04-manage-client-relationship.md) - After conversion to account
