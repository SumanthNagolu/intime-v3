...
- [12-prospect-new-client.md](./12-prospect-new-client.md) - Previous step
- [14-create-account.md](./14-create-account.md) - Next step if qualified
- [02-create-job.md](./02-create-job.md) - Next step after account created
- [15-manage-client-relationship.md](./15-manage-client-relationship.md) - Ongoing after conversion
