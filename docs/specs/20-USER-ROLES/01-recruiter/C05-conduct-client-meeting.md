...
- [C04-manage-client-relationship.md](./C04-manage-client-relationship.md) - Ongoing relationship
- [D01-create-job.md](./D01-create-job.md) - Creating jobs from meeting
- [C06-handle-client-escalation.md](./C06-handle-client-escalation.md) - If issues arise
- [H02-log-activity.md](./H02-log-activity.md) - Activity logging
