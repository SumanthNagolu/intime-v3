...
- Subtle animations
- System fonts (SF Pro on Apple platforms, Inter elsewhere)

**Tesla (Sleekness & Technology):**
- Dark mode first
- Bold typography
- Data visualization emphasis
- Futuristic feel without being garish
- Performance-focused UI (fast, responsive)

**Deloitte (Trustworthiness & Professionalism):**
...
export const tokens = {
  colors: {
    // Primary (Professional Blue - Deloitte inspired)
    primary: {
      50: '#eff6ff',
      100: '#dbeafe',
    ...
    // Accent (Tech Green - Tesla inspired)
    accent: {
      500: '#10b981',
      900: '#064e3b',
    },

    // Neutrals (Minimal - Apple inspired)
    neutral: {
      0: '#ffffff',
      50: '#f9fafb',
      100: '#f3f4f6',
  ...
  typography: {
    // Apple-inspired: SF Pro on macOS, Inter elsewhere
    fontFamily: {
  ...
  borderRadius: {
    none: '0',
    sm: '0.25rem',   // 4px
    md: '0.5rem',    // 8px (Apple-style rounded corners)
    lg: '0.75rem',   // 12px
    xl: '1rem',      // 16px
    full: '9999px',
  },
...
**Card Component (Apple Minimalism):**
```tsx
<Card className="bg-white dark:bg-neutral-900 rounded-lg shadow-md p-6">
  <CardHeader>
    <CardTitle className="text-2xl font-semibold text-neutral-900 dark:text-neutral-0">
      Title
    </CardTitle>
  </CardHeader>
...
**Data Visualization (Tesla Tech Feel):**
- Use Recharts with dark theme
- Bold colors for data points
- Smooth animations
- Tooltips with detailed info

**Dashboard Layout (Deloitte Professional):**
- Grid-based layouts
- Clear sections
...
export const fadeIn = {
  ...
  animate: { opacity: 1 },
  exit: { opacity: 0 },
  transition: { duration: 0.2 }, // Fast, Apple-style
};
...
- Default duration: 200-300ms (Apple standard)
