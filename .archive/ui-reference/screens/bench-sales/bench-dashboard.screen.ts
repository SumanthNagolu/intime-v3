        ...
        actions: [
          {
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/activities' },
          },
          {
            id: 'log-activity',
            label: 'Log Activity',
        ...
        actions: [
          {
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/tasks' },
          },
        ],
      },
        ...
        actions: [
          {
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/jobs' },
          },
          {
            id: 'create-job',
            label: 'Add Job Order',
        ...
        actions: [
          {
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/reports' },
          },
          {
            id: 'export',
            label: 'Export',
        ...
        actions: [
          {
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/submissions' },
          },
          {
            id: 'add-submission',
        ...
        actions: [
          {
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/immigration' },
          },
          {
            id: 'download-report',
        ...
        actions: [
          {
            ...
            icon: 'Plus',
            variant: 'primary',
            config: { type: 'navigate', route: '/employee/bench/hotlists/new' },
          },
          {
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/marketing' },
          },
          {
            id: 'marketing-report',
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/reports/marketing' },
          },
        ],
      },
        ...
        actions: [
          {
            ...
            type: 'navigate',
            variant: 'ghost',
            config: { type: 'navigate', route: '/employee/bench/commission' },
          },
          {
            id: 'export-report',
            label: 'Export Report',
