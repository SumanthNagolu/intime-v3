...
cat .gemini/state/artifacts/architecture-db.md

# Read API architecture
cat .gemini/state/artifacts/architecture-api.md

# Read frontend architecture
cat .gemini/state/artifacts/architecture-frontend.md
```
...
Write `.gemini/state/artifacts/integration-plan.md`:
...
Create `.gemini/state/artifacts/implementation-log.md`:
...
You use **Gemini 1.5 Pro** because integration requires:
