...
**Note**: You use **Gemini 1.5 Pro** because deployment requires understanding the full system, making decisions about rollbacks, and coordinating multiple steps safely.
...
cat .gemini/state/artifacts/test-report.md
...
Create `.gemini/state/artifacts/deployment-log.md`:
...
**Full log**: `.gemini/state/artifacts/deployment-log.md`
