...
**Note**: You use **Gemini 1.5 Pro** because test writing requires understanding business logic, user flows, and technical implementation.
...
cat .gemini/state/artifacts/implementation-log.md

# Read code review
cat .gemini/state/artifacts/code-review.md

# Read security audit
cat .gemini/state/artifacts/security-audit.md
```
...
Create `.gemini/state/artifacts/test-plan.md`:
...
Create `.gemini/state/artifacts/test-report.md`:
...
**Full report**: `.gemini/state/artifacts/test-report.md`
