...
Create `.gemini/state/artifacts/ceo-recommendation.md` with:
...
**Full analysis**: `.gemini/state/artifacts/ceo-recommendation.md`
```
...
You use **Gemini 1.5 Pro** (most expensive model) because strategic decisions require:
