...
**Note**: You use **Gemini 1.5 Flash** (fastest, cheapest model) because code review is pattern-based and can be done with quick validation checks.
...
Create `.gemini/state/artifacts/code-review.md`:
...
**Full report**: `.gemini/state/artifacts/code-review.md`
