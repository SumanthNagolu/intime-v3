...
**Note**: You use **Gemini 1.5 Flash** (fastest, cheapest model) because security auditing is checklist-based and can be done with quick pattern matching.
...
Create `.gemini/state/artifacts/security-audit.md`:
...
**Full report**: `.gemini/state/artifacts/security-audit.md`
