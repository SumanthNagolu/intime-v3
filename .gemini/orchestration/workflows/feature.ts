...
Write the requirements to requirements.md for the architecture team.
    `.trim(),
    outputFile: '.gemini/state/artifacts/requirements.md',
  ...
  // Step 2a: Database Architecture (parallel with API/Frontend)
  {
    ...
    inputFiles: ['.gemini/state/artifacts/requirements.md'],
    outputFile: '.gemini/state/artifacts/architecture-db.md',
    parallel: true,
  },
  ...
  // Step 2b: API Development (parallel with DB/Frontend)
  {
    ...
    inputFiles: ['.gemini/state/artifacts/requirements.md'],
    outputFile: '.gemini/state/artifacts/architecture-api.md',
    parallel: true,
  },
  ...
  // Step 2c: Frontend Development (parallel with DB/API)
  {
    ...
    inputFiles: ['.gemini/state/artifacts/requirements.md'],
    outputFile: '.gemini/state/artifacts/architecture-frontend.md',
    parallel: true,
  },
  ...
  // Step 3: Integration (after parallel architecture steps)
  {
    ...
    inputFiles: [
      '.gemini/state/artifacts/architecture-db.md',
      '.gemini/state/artifacts/architecture-api.md',
      '.gemini/state/artifacts/architecture-frontend.md',
    ],
    outputFile: '.gemini/state/artifacts/implementation-log.md',
  },
  ...
  // Step 4a: Code Review (parallel with Security)
  {
    ...
    inputFiles: ['.gemini/state/artifacts/implementation-log.md'],
    outputFile: '.gemini/state/artifacts/code-review.md',
    parallel: true,
  },
  ...
  // Step 4b: Security Audit (parallel with Code Review)
  {
    ...
    inputFiles: ['.gemini/state/artifacts/implementation-log.md'],
    outputFile: '.gemini/state/artifacts/security-audit.md',
    parallel: true,
  },
  ...
  // Step 5: QA Testing
  {
    ...
    inputFiles: [
      '.gemini/state/artifacts/implementation-log.md',
      '.gemini/state/artifacts/code-review.md',
      '.gemini/state/artifacts/security-audit.md',
    ],
    outputFile: '.gemini/state/artifacts/test-report.md',
  },
  ...
  // Step 6: Deployment
  {
    ...
    inputFiles: ['.gemini/state/artifacts/test-report.md'],
    outputFile: '.gemini/state/artifacts/deployment-log.md',
