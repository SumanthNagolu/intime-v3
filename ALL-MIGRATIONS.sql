-- ============================================================================
-- CONSOLIDATED MIGRATIONS - InTime v3
-- Created: 2025-11-19
-- Description: All database migrations in execution order
-- ============================================================================
...
-- ============================================================================
-- FILE: 003_create_rbac_system.sql
-- ============================================================================
...
-- ============================================================================
-- FILE: 004_create_audit_tables.sql
-- ============================================================================
...
CREATE OR REPLACE FUNCTION create_audit_log_partition(partition_date TIMESTAMP)
RETURNS VOID AS $$
DECLARE
  partition_name TEXT;
  start_date DATE;
...
-- ============================================================================
-- FILE: 007_add_multi_tenancy.sql
-- ============================================================================
...
--
-- 1. Check multi-tenancy status:
-- SELECT * FROM v_multi_tenancy_status;
--
-- 2. Check organization stats:
-- SELECT * FROM v_organization_stats;
--
-- 3. Verify all user_profiles have org_id:
...
-- FROM pg_policies
-- WHERE tablename IN ('organizations', 'user_profiles', 'audit_logs', 'events', 'event_delivery_log')
-- ORDER BY tablename, policyname;
--
-- 5. Test org isolation (as a non-admin user):
-- SET ROLE your_app_user;
-- SELECT COUNT(*) FROM user_profiles WHERE org_id != auth_user_org_id();
-- -- Should return 0 (can't see users from other orgs)
